...
A demo program can be seen [here](https://github.com/Aleksei-Badyaev/go-msi/tree/master/testing/hello).

## Install

Download from the [release page](https://github.com/Aleksei-Badyaev/go-msi/releases) or use `go get`:
```sh
go get github.com/Aleksei-Badyaev/go-msi
```
...
- Create a `wix.json` file like [this one](https://github.com/Aleksei-Badyaev/go-msi/blob/master/testing/hello/wix.json)
...
Check the demo [wix.json](https://github.com/Aleksei-Badyaev/go-msi/blob/master/testing/hello/wix.json) file.
